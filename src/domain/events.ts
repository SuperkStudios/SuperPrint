export const platformEventTypes = [
  ...
  "FILAMENT_LOW",
  "MAINTENANCE_DUE",
  "PRODUCTION_PLATE_READY",
  "PRODUCTION_FILAMENT_CHANGE_REQUIRED",
  "PRODUCTION_FILAMENT_CHANGE_COMPLETED",
  "PRODUCTION_PLATE_CLEAR_CHECK_PASSED",
  "PRODUCTION_PLATE_CLEAR_CHECK_FAILED",
  "PRODUCTION_PLATE_PRINT_STARTED",
  "PRODUCTION_PLATE_PRINT_COMPLETED",
