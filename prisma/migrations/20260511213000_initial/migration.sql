...
-- CreateEnum
CREATE TYPE "PrintJobStatus" AS ENUM ('QUEUED', 'PRINTING', 'PAUSED', 'COMPLETED', 'FAILED', 'CANCELED');
...
-- CreateEnum
CREATE TYPE "PlatformEventType" AS ENUM ('ORDER_CREATED', 'MODEL_UPLOADED', 'MODEL_APPROVED', 'MODEL_REJECTED', 'PRINT_STARTED', 'PRINT_PAUSED', 'PRINT_REQUEUED', 'PRINT_COMPLETED', 'PRINT_FAILED', 'FILAMENT_LOW', 'MAINTENANCE_DUE', 'VIDEO_READY');
